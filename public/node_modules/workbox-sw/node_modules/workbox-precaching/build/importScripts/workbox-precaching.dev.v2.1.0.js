...
function isServiceWorkerGlobalScope(){return'ServiceWorkerGlobalScope'in self&&self instanceof ServiceWorkerGlobalScope}function isDevBuild(){return`dev`==`dev`}
...
}((this.workbox.precaching = this.workbox.precaching || {})));
//# sourceMappingURL=workbox-precaching.dev.v2.1.0.js.map
